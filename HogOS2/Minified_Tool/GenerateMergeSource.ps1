...
$source = Join-Path $projectRoot "Scripts\HogOS.cs"
$generatedDir = Join-Path $toolRoot "HogOS_Minified\Generated"
$generated = Join-Path $generatedDir "HogOS_Merge.cs"

if (!(Test-Path -LiteralPath $source)) {
    throw "Missing HogOS source: $source"
}
